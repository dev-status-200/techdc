      ...
      {!load &&
        ...
        <div>
          ...
          <Container> 
           ...
           <div className='grey-bg py-3 my-5'> 
            <Container>
          ...
          <div className='my-5'> 
            ...
            <Container className=''>
              ...
              <Col xs={12} className="">
                ...
                <span className='img-desig-mobile'>DIRECTOR STRATEGIC PLANNING</span>
                </div>
              </Col>
              <Col xs={12} className="">
                <div className='text-center'>
                ...
                <span className='img-desig-mobile'>DIRECTOR PUBLIC RELATIONS</span>
                </div>
              </Col>
              <Col xs={12} className="">
                <div className='text-center'>
                ...
                <span className='img-desig-mobile'>DIRECTOR TRAINING & RESEARCH</span>
                </div>
              </Col>
              <Col xs={12} className="">
                <div className='text-center'>
                ...
                <span className='img-desig-mobile'>HR BUSINESS PARTNER</span>
                </div>
              </Col>
              <Col xs={12} className="">
                <div className='text-center'>
                ...
                <span className='img-desig-mobile'>DIRECTOR REGISTRATIONS</span>
                </div>
              </Col>
