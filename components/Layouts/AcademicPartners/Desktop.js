      ...
      {!load &&
        ...
        <div>
          <Container> 
            <Row className='px-5'>
              <Col md={6}>
                <h3 style={{fontWeight:300}}>Academic Partners</h3>
        ...
        <div className='my-5 py-5'>
            <Container>
                <Row className='text-center'>
                    ...
                    <Col md={12}>
                        <Row className='px-5 mt-5' data-aos="slide-up">
                            <Col md={1}></Col>
                            <Col md={5} className="">
                                <div className='green-box p-5 mb-5 mx-3 white'>
                                HEC and NTC recognized Bachelor's degree programs
                                </div>
                            ...
                            <Col md={5} className="">
                                ...
                                {" "}12 traingings per {" "} year with their<br/> academic classes{" "}
                                </div>
                            </Col>
                            <Col md={1}></Col>
                        </Row>
